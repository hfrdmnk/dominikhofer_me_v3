...
{{< prose >}}
This is a (not at all complete) list of the tools I use in my life.

I’m always trying to reduce the amount of “stuff” in my life (be it physical tools, apps or subscriptions) in favor of things I really love. There is still a long way to go, but over the years, the list feels way more intentional.

## Hardware

- Computer: [Apple MacBook Air M2 15”](https://www.apple.com/macbook-air/)
- Display: [Apple Studio Display](https://www.apple.com/studio-display/)
- Keyboard: [Keychron K3 Mechanical Keyboard](https://www.keychron.com/products/keychron-k3-wireless-mechanical-keyboard)
- Mouse: [Logitech MX Vertical](https://www.logitech.com/en-us/shop/p/mx-vertical-ergonomic-mouse)
...
- App Launcher: [Raycast](http://raycast.com/)
- Terminal: [Ghostty](https://ghostty.org/)
- Code Editor: [Zed](https://zed.dev/)
- Issue Tracker: [Linear](https://linear.app/)
- AI: [ChatGPT](https://chatgpt.com/) (Personal), [Claude](https://claude.ai/) (Work)
...
These are just random subjects that always bring me joy and/or make my life better.
...
Small-ish tools that always put a smile on my face:
