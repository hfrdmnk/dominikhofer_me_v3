...
Today is the last day of my [writing PACT](/writing-pact) where I set out to write and publish a blog post every day for 30 days.

I’ve written about various things that were on top of mind: [Side projects](/the-power-of-side-projects), [sport](/where-athletes-meet), [personal finance](/the-art-of-spending-money), [general life advice that I found useful](/mood-shifters), [replies to blog posts](/re-the-joy-of-building-slow) and lately about [our new family member](/welcome-naida).

Funny enough, the most popular post by far (at least according to my Plausible analytics) was a relatively simple (no pun intended) one: [The simplest read-later app](/the-simplest-read-later-app). It’s essentially just resharing an even shorter article from [Marcel](https://marcel.io/posts/how-i-manage-my-read-later-list), with a few additional comments by me. His repost on Mastodon was probably the reason why it gained some traction.
